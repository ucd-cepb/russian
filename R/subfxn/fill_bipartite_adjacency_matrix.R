...
#'
#' @param network_data a data frame with the columns: id, v.  
...
#' 
#' @export
fill_bipartite_adjacency_matrix <- function(network_data, empty_A = NULL, weights=FALSE){
